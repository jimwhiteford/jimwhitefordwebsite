...
const Toc = ({ headings }: any) => (
  <div className="max-w-2xl mx-auto mt-8 border rounded-sm dark:border-black bg-slate-100">
        ...
        {headings?.map((heading: any) => (
          <li key={heading?._key} className="mb-2">
            {heading.style == "h2" ? (
              ...
              <a
                className={"hover:underline text-md font-semibold ml-6"}
                href={`#${slugify(heading.children[0].text)}`}
              >
                {heading.children[0].text}
              </a>
              ...
              <a
                className={"hover:underline text-sm ml-12"}
                href={`#${slugify(heading.children[0].text)}`}
              >
                {heading.children[0].text}
              </a>
